          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
              ...
              <div className="space-y-2">
                ...
                <Input name="location" placeholder="e.g. Rupandehi" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium">Partner Organization</label>
                <Input name="partner" placeholder="e.g. Stromme Foundation" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium">Duration</label>
                <Input name="duration" placeholder="e.g. 2024-Present" />
              </div>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t">
              <div className="space-y-2">
                ...
                <Input name="featured_image" placeholder="/Image/Projects/..." />
