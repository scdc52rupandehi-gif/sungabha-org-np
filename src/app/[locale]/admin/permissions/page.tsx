...
import { deletePermission } from "@/app/actions/permissions";
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Permissions</h2>
      ...
      <Card>
        ...
        <CardContent>
          <DataTable 
            ...
            actions={(item) => (
              <>
                <Link href={`/admin/permissions/${item.id}/edit`}>
